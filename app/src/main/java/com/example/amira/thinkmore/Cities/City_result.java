...
public class City_result extends AppCompatActivity {
    TextView textView;
    Button button;
    ...
    public void playagain(View o) {
        ...
        Intent intent = new Intent(getApplicationContext(), City_questionactivity.class); //// in this part i will make 2 button continue play agin or return to main page
